...
0    4    magic       "FBC1"
4    2    verMajor    1
6    2    verMinor    12（递增原因＝新增 opcode / 新增 helper / 类型表格式变更 / CALL_HELPER hid 值域扩展；历史：v0.4=1、v0.5=2、v0.6=3、v0.7=4、v0.8=5、v0.10=6、v0.11=7、v0.15=8、v0.16=9、v0.17=10、v0.18=11、v0.18.19=12；加载器接受 ≤ 自身版本的 verMinor）
